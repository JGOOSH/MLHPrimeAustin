...
import com.daprlabs.aaron.swipedeck2.MainActivity;
import com.daprlabs.aaron.swipedeck2.R;
...
public class ChatActivity extends FragmentActivity implements ChannelListener, ILoginListener, IPMessagingClientListener {
    ...
    // Authentication
    private static final String AUTH_SCRIPT = "http://14bfae39.ngrok.io/token";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        basicClient = com.twilio.ipmessaging.application.TwilioApplication.get().getBasicClient();
        if(basicClient != null) {
            // Authentication
            authenticateUser();
        }
        ...
        // Chat
        currentCard = getIntent().getIntExtra(MainActivity.EXTRA_CARD, -1);
    ...
    public void onLoginFinished() {
        ...
        final String channelName = "TestChannel" + String.valueOf(currentCard);
        ...
        if (channelsLocal.getChannelByUniqueName(channelName) != null) {
            ...
            attributes.put("topic", "Discussion on image : " + String.valueOf(currentCard));
